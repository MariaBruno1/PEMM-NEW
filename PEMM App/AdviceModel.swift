...
//  PEMM App
//
//  Created by Maria Bruno on 24/10/23.
//
...
class AdviceModel {
    ...
    var advices = [
        ...
        Advice(name: "Downward facing dog", description: "This yoga position is one of the best known asanas. Stretches your entire body and strengthens your back and shoulders. If performed regularly, this exercise can relieve headaches and neck pain. Starting from a quadruped position, place your toes on the ground, inhale deeply and as you exhale push your hips up. Your body now forms an inverted V. Arms and legs are well stretched and the back is relaxed. You can maintain this position or walk a little on the spot, so as to loosen the ligaments and tendons.", imageName: "Donward facing dog image"),
        Advice(name: "Forward bends", description: "The next yoga pose strengthens your mind, improves your flexibility, increases blood flow to the brain, and stretches your ligaments. Thanks to the pressure exerted by your feet on the floor, this exercise engages you both physically and mentally. Starting in downward-facing dog position, bring your feet forward toward the center of the mat. Lean forward and touch your toes or hug your lower legs. The legs should not be straight but slightly bent in a relaxed manner. But make sure you keep your back straight. Then relax your shoulders and arms in a controlled manner. If your neck starts to pull, move your head slightly to the right and left. Hold this yoga position for 5 deep breaths.", imageName: "Forward bends image"),
